module.exports = {
    msalInit: function(successCallback, errorCallback, options) {
        ...
        cordova.exec(successCallback, errorCallback, 'azureadb2c', 'msalInit', [JSON.stringify(options)]);
    },
    startLogger: function(updateCallback, errorCallback, containsPII = false, logLevel = 'VERBOSE') {
        cordova.exec(updateCallback, errorCallback, 'azureadb2c', 'startLogger', [containsPII, logLevel]);
    },
    getAccounts: function(successCallback, errorCallback) {
        cordova.exec(successCallback, errorCallback, 'azureadb2c', 'getAccounts', []);
    },
    signInSilent: function(successCallback, errorCallback, account) {
        cordova.exec(successCallback, errorCallback, 'azureadb2c', 'signInSilent', [account]);
    },
    signInInteractive: function(successCallback, errorCallback, signInOptions) {
        ...
        cordova.exec(successCallback, errorCallback, 'azureadb2c', 'signInInteractive', opts);
    },
    signOut: function(successCallback, errorCallback, account) {
        cordova.exec(successCallback, errorCallback, 'azureadb2c', 'signOut', [account]);
    }
};